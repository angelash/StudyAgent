...
class FeedbackEvent {
  ...
  sourceRefType: 'mission' | 'item' | 'knowledge_progress';
  sourceRefId: string;
}
```
...
2. `PracticeWorkspace` 承载答题、提示、恢复链路
3. `FeedbackToast` 承载即时反馈
4. `MissionSummaryCard` 展示任务完成后的复盘
